...
## This code write and saves the Stan code for the heirarchical Bayesian GLM

## This model assumes
## * species are independent
## * spatial variables are independent and linear
## * month is a factor
...
writeLines(stan_code, "location_estimation_model.stan")
